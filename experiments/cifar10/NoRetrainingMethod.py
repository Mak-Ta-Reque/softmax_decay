...
if __name__ == '__main__':
    ...
    while run_params is not None:
        ...
        res_acc, prob_acc = run_road(model, dataset_test, expl_test, normalize_transform, [perc_value], morf=morf, batch_size=batch_size, imputation = imputer, ranking=ranking, softmax=False)
