...
def softmax_eval(model, testloader):
    ...
    with torch.no_grad():
        ...
        for i, data in enumerate(testloader):
            ...
            for l, val in zip(labels, probs):
                class_sepcific_prob.append(val[l].item())
            #class_sepcific_prob = torch.index_select(probs, 0, torch.ones((1,40)))
    ...
    return class_sepcific_prob, prob_avg
